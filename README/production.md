...
This guide will walk you through the fundamental steps to integrate Primus's Tip SDK and complete a basic tip process through your application. You can learn about the integration process through this simple [demo](https://github.com/primus-labs/zktls-demo/tree/main/production-example) TODO.
...
const tipToken = {
  tokenType: 0,
  tokenAddress: "0xE89f5CA611424A1053ED7946ce96e279959f8dC1",
};
```

##### 2. tipRecipientInfo

We support tipping multiple users at once. The information of the recipient includes the data source ID, the userId on that data source, and the amount of tokens tipped. Note the unit of the amount; if you want to tip one token, you only need to pass "1". just like this:
...
export async function primusTip() {
  try {
    ...
    // tokenType: When the token is a native coin, pass 1; when the token is ERC-20, pass 0, and remember to pass the tokenAddress.
    const tipToken = {
      tokenType: 0,
      tokenAddress: "0xE89f5CA611424A1053ED7946ce96e279959f8dC1",
    };
